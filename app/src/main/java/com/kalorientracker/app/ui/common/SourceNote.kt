...
private val SOURCES = listOf(
    "Energiebedarf" to "Ruheenergieverbrauch × PAL, wie die Deutsche Gesellschaft für Ernährung (DGE) ihre Referenzwerte ableitet. Die Formel nutzt Gewicht und Alter. Welcher PAL-Wert gilt, schätzt die App aus deinen Schritten, die Stufen selbst (1,4 bis 1,9) stammen von der DGE.",
    ...
    "Protein" to "Der DGE-Referenzwert sind 0,8 g je kg Körpergewicht. Für deine Ziele rechnet die App höher, mit 1,6 bis 2,0 g je kg nach dem ISSN Position Stand „Protein and Exercise“ (2017). Weniger als den DGE-Wert setzt sie nie an.",
